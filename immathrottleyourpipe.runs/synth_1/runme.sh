...
HD_PWD='C:/Users/cakulev2/immathrottleyourpipe/immathrottleyourpipe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JTEG_Test_File.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JTEG_Test_File.tcl
