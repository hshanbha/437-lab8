...
#
# Generated by Vivado on Thu Mar 07 11:19:50 -0600 2019
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/hshanbha/immathrottleyourpipe/immathrottleyourpipe.cache/compile_simlib/activehdl"
  fi
